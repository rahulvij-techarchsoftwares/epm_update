...
export function Sidebar() {
  ...
  return (
    <aside className="bg-white shadow-lg fixed left-0 top-0 h-full w-72 z-40 rounded-xl transition-transform duration-300 xl:translate-x-0 border border-gray-200 flex flex-col justify-between">
      <div>
      ...
      <div className="m-4">
        <button
          onClick={logout}
          className="w-full flex items-center px-4 py-2 rounded-lg transition-colors font-medium capitalize text-gray-700 hover:bg-gray-100"
        >
          LogOut
        </button>
      </div>
